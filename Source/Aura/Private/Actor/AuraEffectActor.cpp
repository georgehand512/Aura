...
{
	// check first if actor is an enemy whom we do not want to apply effect to
	...
	{
		ActiveEventHandles.Add(ActiveEffectHandle, TargetASC);
	}
...
void AAuraEffectActor::OnOverlap(AActor* TargetActor)
{
	...
	if (InfiniteEffectRemovalPolicy == EEffectRemovalPolicy::RemoveOnOverlap)
	{
		...
		for (TTuple<FActiveGameplayEffectHandle, UAbilitySystemComponent*> HandlePair : ActiveEventHandles)
		{
