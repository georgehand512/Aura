...
// local function to refactor Show Damage Text code
void UAuraAttributeSet::ShowFloatingText(const FEffectProperties& Props, float Damage, bool bBlockedHit, bool bCriticalHit) const
{
	if (!IsValid(Props.SourceCharacter) || !IsValid(Props.TargetCharacter)) return;
	
	// call show damage text, but only if damaged charatcter is not the player
...
// local function to get XP value from affected actor and send to damage causer
